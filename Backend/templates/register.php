                                    ...
                                    <form class="form-horizontal" action="index.php" novalidate>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" name="display_name" id="display_name" class="form-control input-lg"
                                                   placeholder="Username" tabindex="3" required data-validation-required-message="Please enter display name.">
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6 col-md-6">
                                                <button <a href="index.php" type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-user"></i> Register </a></button>
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-6">
