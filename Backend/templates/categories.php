                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <a href="CategoryForm.php" type="button" class="btn btn-primary"> Add New </a>
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12"><table class="table table-striped table-bordered base-style dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            <thead>
                                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 300px;">Name</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 300px;">Action</th></tr>
                                            </thead>
                                            <tbody>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">Clothes</td>
                                                <td><a class="btn btn-sm btn-info"><i class="la la-pencil"></i></a>
                                                <a class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a></td>
                                            </tr><tr role="row" class="even">
                                            <td class="sorting_1">Shoes</td>
                                                <td><a class="btn btn-sm btn-info"><i class="la la-pencil"></i></a>
                                                <a class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a></td>
                                            </tr><tr role="row" class="odd">
                                            <td class="sorting_1">Accessories</td>
                                                <td><a class="btn btn-sm btn-info"><i class="la la-pencil"></i></a>
                                                <a class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a></td>
                                            </tr><tr role="row" class="even">
                                            </tr></tbody>
                                            <tfoot>
                                            <tr><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Action</th></tr>
                                            </tfoot>
