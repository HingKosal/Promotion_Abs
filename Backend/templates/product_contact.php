            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        ...
                        <a href="ProductDetailForm.php" type="button" class="btn btn-primary"> Add New </a>
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12"><table class="table table-striped table-bordered base-style dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            <thead>
                                            <tr role="row">
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 98px;">Company Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 98px;">Branch</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 98px;">Company Address</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 98px;">Phone</th></tr>
                                            </thead>
                                            <tbody>

                                            </tbody>
<!--                                            <tfoot>-->
<!--                                            <tr><th rowspan="1" colspan="1">Order ID</th><th rowspan="1" colspan="1">Product ID</th><th rowspan="1" colspan="1">Product Name</th><th rowspan="1" colspan="1">Brand</th><th rowspan="1" colspan="1">Price</th>Quantity</th><th rowspan="1" colspan="1">description</th><th rowspan="1" colspan="1">Quantity</th><th rowspan="1" colspan="1">Size</th><th rowspan="1" colspan="1">Company Name</th><th rowspan="1" colspan="1">Branch</th><th rowspan="1" colspan="1">Company Address</th><th rowspan="1" colspan="1">Phone</th></tr>-->
<!--                                            </tfoot>-->
