...
<!--                                <h4 class="form-section"><i class="ft-user"></i> Personal Info</h4>-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" id="projectinput2" class="form-control" placeholder="Price" name="price">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput3">Quantity</label>
                                    <div class="col-md-5">
                                        <input type="text" id="projectinput3" class="form-control" placeholder="Quantity" name="quantity">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput4">Category</label>
                                    <div class="col-md-5">
                                        <input type="text" id="projectinput4" class="form-control" placeholder="Category" name="category">
                                    </div>
                                </div>
