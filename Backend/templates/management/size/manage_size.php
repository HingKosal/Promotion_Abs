                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <div style="margin-left: 15px;">
                                <a href="management/size/createsize.php" type="button" class="btn btn-primary"> Add New </a>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    if($result = mysqli_query($conn, $sql)){
                                        if(mysqli_num_rows($result) > 0){
                                            ...
                                            echo "<thead>";
                                            echo "<tr role='row'>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 5%;'>Six ID</th>";
                                            ...
                                            while($row=mysqli_fetch_array($result)){
                                                ...
                                                echo"<td>";
                                                echo"<a href = 'edit_size.php?edit=". $row['size_id'] ."' class='btn btn-sm btn-info'><i class='la la-pencil'></i></a>";
                                                echo"<a href = 'crud_size.php?delete=". $row['size_id'] ."' class='btn btn-sm btn-danger'><i class='la la-trash-o'></i></a></td>";
                                             echo"</td>";
                                         echo"</tr>";
                                         }
                                         echo"<tbody>";
