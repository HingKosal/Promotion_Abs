                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <div style="margin-left: 15px;">
                                <a href="createcompany.php" type="button" class="btn btn-primary"> Add New </a>
                            </div>
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                    <?php
                                    $sql = "SELECT * FROM companies c, provinces p where c.province=p.province_id";
                                    if($result = mysqli_query($conn, $sql)){
                                        ...
                                        echo"<table class='table table-striped table-bordered base-style dataTable' id='DataTables_Table_0' role='grid' aria-describedby='DataTables_Table_0_info'>";
                                            echo "<thead>";
                                            echo "<tr role='row'>";
                                                echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 5%;'>ID</th>";
                                                echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Company name</th>";
                                                echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Location</th>";
                                                echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Phone</th>";
                                                echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Description</th>";
                                            ...
                                            while($row=mysqli_fetch_array($result)){
                                                ...
                                                echo"<td>";
                                                   echo"<a href = 'edit_company.php?edit=". $row['user_id'] ."' class='btn btn-sm btn-info'><i class='la la-pencil'></i></a>";
                                                   echo"<a href = 'crud_company.php?delete=". $row['user_id'] ."' class='btn btn-sm btn-danger'><i class='la la-trash-o'></i></a></td>";
                                                echo"</td>";
                                            echo"</tr>";
                                            }
                                            echo"<tbody>";
