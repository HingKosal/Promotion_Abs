        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form form-horizontal" action="crud_company.php" method="POST">
                            <div class="form-body">
                            <?php require_once 'crud_company.php' ?>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">ID: </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $id;?>" placeholder="ID" name="user_id" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Company Name: </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $name;?>" placeholder="company name" name="name">
                                    </div>
                                </div>
                                <div class="form-group row" >
                                    <label class="col-md-3 label-control" for="projectinput1">Provinces: </label>
                                        <select class="custom-select col-md-2" id="" style="margin-left:15px;" name="province">
                                            <?php
                                                ...
                                                $query = "select * from provinces where province_id='$province'";
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $phone;?>" placeholder="phone number" name="phone">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-primary" name="update_company">
