<?php
//  require_once 'crud_promotion.php' 
 ?>
<!DOCTYPE html>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form form-horizontal" action="crud_promotion.php" method="POST">
                            <div class="form-body">
                            <?php require_once 'crud_promotion.php' ?>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Promotion ID: </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $id;?>" placeholder="ID" name="promotion_id" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Product Name: </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $name;?>" placeholder="product name" name="product_name">
                                    </div>
                                </div>
                                <div class="form-group row" >
                                    <label class="col-md-3 label-control" for="projectinput1">Category: </label>
                                        <select class="custom-select col-md-2" id="" style="margin-left:15px;" name="category_id">
                                            <?php
                                                ...
                                                $query = "select * from categories where category_id='$cid'";
                                ...
                                <div class="form-group row" >
                                    <label class="col-md-3 label-control" for="projectinput1">Brand: </label>
                                        <select class="custom-select col-md-2" id="" style="margin-left:15px;" name="brand_id">
                                            <?php
                                                include_once('../../../config/connect.php');
                                                $query = "select * from brands where brand_id='$bid'";
                                                $result = mysqli_query($conn, $query);
                                                while($row = mysqli_fetch_array($result)){
                                            ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $price;?>" placeholder="price" name="price">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Discount: </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $discount;?>" placeholder="Discount" name="discount">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Description:</label>
                                    <div class="col-md-5">
                                        <textarea name="description" id="projectinput1" cols="70" rows="4" ><?php echo $desc;?></textarea>  
                                    </div>
                                </div>
                                <div class="form-group row" >
                                    <label class="col-md-3 label-control" for="projectinput1">Size: </label>
                                        <select class="custom-select col-md-2" id="" style="margin-left:15px;" name="size_id">
                                            <?php
                                                include_once('../../../config/connect.php');
                                                $query = "select * from size where size_id='$sid'";
                                                $result = mysqli_query($conn, $query);
                                                while($row = mysqli_fetch_array($result)){
                                            ?>
                                ...
                                <div class="form-group row" >
                                    <label class="col-md-3 label-control" for="projectinput1">Company name: </label>
                                        <select class="custom-select col-md-2" id="" style="margin-left:15px;" name="user_id">
                                            <?php
                                                include_once('../../../config/connect.php');
                                                $query = "select * from manage_user where user_id='$uid'";
                                                $result = mysqli_query($conn, $query);
                                                while($row = mysqli_fetch_array($result)){
                                            ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $location;?>" placeholder="Location" name="location">
                                    </div>
                                </div>
                                <div class="form-group row">
