                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <div style="margin-left: 15px;">
                                <a href="createcategory.php" type="button" class="btn btn-primary"> Add New </a>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    if($result = mysqli_query($conn, $sql)){
                                        ...
                                        echo"<table class='table table-striped table-bordered base-style dataTable' id='DataTables_Table_0' role='grid' aria-describedby='DataTables_Table_0_info'>";
                                            ...
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 5%;'>Category ID</th>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Tittle</th>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 50%;'>Description</th>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Actio</th>";
                                            echo "</thead>";
                                            echo"<tbody>";
                                            while($row=mysqli_fetch_array($result)){
                                                ...
                                                echo"<td>";
                                                   echo"<a href = 'edit_category.php?edit=". $row['category_id'] ."' class='btn btn-sm btn-info'><i class='la la-pencil'></i></a>";
                                                   echo"<a href = 'crud_category.php?delete=". $row['category_id'] ."' class='btn btn-sm btn-danger'><i class='la la-trash-o'></i></a></td>";
                                                echo"</td>";
                                            echo"</tr>";
                                            }
                                            echo"<tbody>";
