<?php
//  require_once 'crud_category.php' 
 ?>
<!DOCTYPE html>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form form-horizontal" action="crud_category.php" method="POST">
                            <div class="form-body">
                            <?php require_once 'crud_category.php' ?>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">ID: </label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" value="<?php echo $id;?>" placeholder="ID" name="category_id" readonly="readonly">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <textarea name="description" id="projectinput1" cols="70" rows="4" ><?php echo $description;?></textarea>  
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <button type="button" class="btn btn-warning mr-1">
                                    <a href="categories.php"><i class="ft-x"></i> Cancel</a>
                                </button>
