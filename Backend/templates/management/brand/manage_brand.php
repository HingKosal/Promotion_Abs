                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <div style="margin-left: 15px;">
                                <a href="createbrand.php" type="button" class="btn btn-primary"> Add New </a>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    if($result = mysqli_query($conn, $sql)){
                                        if(mysqli_num_rows($result) > 0){
                                            ...
                                            echo "<thead>";
                                            echo "<tr role='row'>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 5%;'>Brand ID</th>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 15%;'>Brand Name</th>";
                                            echo"<th class='sorting' tabindex='0' aria-controls='DataTables_Table_0' rowspan='1' colspan='1' aria-label='Salary: activate to sort column ascending' style='width: 65%;'>Description</th>";
                                            ...
                                            while($row=mysqli_fetch_array($result)){
                                                ...
                                                echo"<td>";
                                                echo"<a href = 'edit_brand.php?edit=". $row['brand_id'] ."' class='btn btn-sm btn-info'><i class='la la-pencil'></i></a>";
                                                echo"<a href = 'crud_brand.php?delete=". $row['brand_id'] ."' class='btn btn-sm btn-danger'><i class='la la-trash-o'></i></a></td>";
                                             echo"</td>";
                                         echo"</tr>";
                                         }
                                         echo"<tbody>";
