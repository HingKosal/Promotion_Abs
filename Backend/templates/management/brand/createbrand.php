<?php include_once('crud_brand.php') ?>
<!DOCTYPE html>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        <form class="form form-horizontal" action="createbrand.php" novalidate method="post">
                            <div class="form-body">
<!--                                <h4 class="form-section"><i class="ft-user"></i> Personal Info</h4>-->
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Brand ID: </label>
                                    <div class="col-md-5">
                                        <input type="text" id="projectinput1" class="form-control" placeholder="brand id" name="brand_id">
                                        <?php if (isset($error)){ ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" id="projectinput1" class="form-control" placeholder="brand title" name="title">
                                        <?php if (isset($error)){ ?>
                                            <p style="color: red"><?php echo $error?> </p>
                                        <?php } ?>
                                    </div>
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn btn-warning mr-1">
                                    <a href="manage_brand.php"><i class="ft-x"></i> Cancel</a>
                                </button>
