<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($email) || empty($pwd)){
            ...
            $sql = "SELECT * FROM manage_user WHERE email = '$email' and password = '$pwd'";
            ...
            if($count == 1) {
                ...
                header("location: templates/management/home/home.php");
                exit();
            }else{
                $err = $email . " not match with " . $pwd . " in record";
            }
        }
    }
?>
                    ...
                    <div class="col-md-4 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal" action="index.php" novalidate method="post">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="email" name="email" class="form-control input-lg" id="user-name" placeholder="Email"
                                        ...
                                        <button <a href="" type="submit" name="submit" class="btn btn-danger btn-block btn-lg"><i class="ft-unlock"></i> Login </a></button>
                                    </form>
                                </div>
                            </div>
