...
<head>
    ...
    <link rel="apple-touch-icon" href="FrontEnd/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="FrontEnd/app-assets/images/ico/favicon.ico">
                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                ...
                                <h6 class="card-subtitle line-on-side text-muted text-center font-large-1 pt-2">
                                    <span>Wellcome To Promotion Ads</span>
                                </h6>
                            </div>
                            <div class="card-footer border-0">
                                <a href="templates/index.php" class="btn btn-info btn-block btn-lg mt-3">Click To HomePage</a>
                            </div>
                        </div>
                    </div>
                </div>
